...
3 Associated medical device may be software or hardware.
  The use of “The Medical Devices Regulations” from here on out refers to both Regulation (EU) 2017/745 – MDR and Regulation
(EU) 2017/746 – IVDR.
                                                                       CLINICAL EVALUATION (MDR) /
 Model of Software                                                      PERFORMANCE EVALUATION
                                                                                (IVDR) - scope
 MDSW
 (with independent intended purpose and claimed CLINICAL                          MDSW only
 BENEFIT)

 MDSW
 (with intended purpose and claimed CLINICAL BENEFIT related         MDSW and the driven or influenced
 to driving or influencing a medical device for a medical                medical device Notes 1,2
 purpose)
 Software driving or influencing the use of a medical device          Driven or influenced medical device
 (with no independent intended purpose or independent claimed        including the software (component or
 CLINICAL BENEFIT)                                                                 accessory)
...
CLINICAL DEVELOPMENT PLAN   A plan indicating progression from exploratory investigations, such
(MDR)                       as first-in-man studies, feasibility and pilot studies, to confirmatory
...
(MDR)                       undertaken to assess the safety or performance of a device.
...
CURATED DATABASE/ CURATED   For the purpose of this document, a curated database/curated registry
REGISTRY                    is any kind of structured repository such as a traditional database, an
...
HUMAN FACTORS ENGINEERING     Human factors engineering refers to the application of knowledge
...
(IVDR)                        SCIENTIFIC VALIDITY, the ANALYTICAL and, where applicable, the
...
TECHNICAL PERFORMANCE         Capability of a MDSW to accurately and reliably generate the
(MDR) /ANALYTICAL (IVDR))     intended technical/analytical output from the input data.
PERFORMANCE                   Source: IMDRF/SaMD WG/N41FINAL:2017
...
VALID CLINICAL ASSOCIATION    Means the association of an MDSW output with a clinical condition
(MDR) / SCIENTIFIC VALIDITY   or physiological state.
(IVDR)                        Source: Derived from IMDRF/SaMD WG/N41FINAL:2017
...
or the healthcare context / situation in which that same device is used might result in a different approach.
 ...
 CLINICAL INVESTIGATION/ CLINICAL                         -   Prospective or retrospective studies
 PERFORMANCE STUDIES                                      -   Existing manufacturer data
 ...
 Published experience gained by routine                   -   REAL-WORLD PERFORMANCE DATA
 diagnostic testing                                       -   Data obtained from PMPF/ PMCF
