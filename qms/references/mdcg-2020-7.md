...
- Confirming the safety (the confirmation of the safety includes the acceptability of identified risks and particularly residual risks) and performance, including the clinical benefit if applicable, of the device throughout its expected lifetime;
...
| --- | --- | --- | --- |
| 01 | *dd/mm/yyyy* | *Initial version* | *Name* |
| 02 | *dd/mm/yyyy* | *Description* | *Name* |
...
| Number of activity | Description of activity | Aim of the activity | Rationale and known limitations | Timelines |
| --- | --- | --- | --- | --- |
| C.1 | *e.g. Device registry* | *Confirming safety and performance* | *Rationale and limitations* | *Quarterly* |
| C.2 | *e.g. PMCF study* | *Identifying unknown side-effects* | *Rationale and limitations* | *Yearly* |
| C.3 | *e.g. Literature review* | *Ensuring benefit-risk acceptability* | *Rationale and limitations* | *Yearly* |
...
| Product name | Intended purpose | Intended users | Patient population | Medical condition | Indication | CER reference |
| --- | --- | --- | --- | --- | --- | --- |
| *Device name* | *Purpose* | *Users* | *Population* | *Condition* | *Indication* | *CER date, version, section* |
| *Device name* | *Purpose* | *Users* | *Population* | *Condition* | *Indication* | *CER date, version, section* |
