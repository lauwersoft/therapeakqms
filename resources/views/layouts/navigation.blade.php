<nav x-data="{ open: false }" x-init="window.addEventListener('pageshow', () => open = false)" class="bg-white border-b border-gray-100 sticky top-0 z-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-6 min-[1150px]:-my-px min-[1150px]:ms-10 min-[1150px]:flex">
            ...
            <!-- Settings Dropdown -->
            <div class="hidden min-[1150px]:flex min-[1150px]:items-center min-[1150px]:ms-6">
            ...
            <!-- Hamburger -->
            <div class="-me-2 flex items-center min-[1150px]:hidden">
