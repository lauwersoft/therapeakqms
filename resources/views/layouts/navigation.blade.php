<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 relative z-50">
    ...
    <div x-show="open"
         ...
         @click="open = false" class="fixed left-0 right-0 bottom-0 bg-gray-900/50 xl:hidden" style="z-index: 45; top: 4rem; display: none;" x-cloak></div>
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0"
         ...
         class="xl:hidden absolute left-0 right-0 bg-white shadow-lg border-b border-gray-200" style="z-index: 55;" x-cloak>
